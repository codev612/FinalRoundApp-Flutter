...
class _PlanUsageSettingsState extends State<_PlanUsageSettings> {
  ...
  static const _PlanOffer _proPlan = _PlanOffer(
    ...
    canUseSummary: true,
    allowedModels: ['gpt-6-astra', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-5.4', 'gpt-5.3', 'gpt-5', 'gpt-5.1', 'gpt-4.1', 'gpt-4.1-mini', 'gpt-4o', 'gpt-4o-mini'],
  );
  static const _PlanOffer _proPlusPlan = _PlanOffer(
    ...
    canUseSummary: true,
    allowedModels: ['gpt-6-astra', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-5.4', 'gpt-5.3', 'gpt-5.2', 'gpt-5', 'gpt-5.1', 'gpt-4.1', 'gpt-4.1-mini', 'gpt-4o', 'gpt-4o-mini'],
  );
